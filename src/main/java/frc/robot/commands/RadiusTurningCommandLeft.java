...
public class RadiusTurningCommandLeft extends CommandBase {
   ...
   */
  public RadiusTurningCommandLeft(Drivetrain pDT, int pAngle, double pSpeed, double pRadius, String pDirection) {
    DT = pDT;
    Angle = pAngle;
    Speed = pSpeed;
    Radius = pRadius;
