...
public class DrivetrainRearLeftPosition extends CommandBase {
  private static int Ticks;
  /**
   * Creates a new DrivetrainFrontRearPosition.
   */
  public DrivetrainRearLeftPosition(int pTicks) {
    Ticks = pTicks;
  ...
  public void initialize() {
    // Encoders are reset in DrivetrainFrontLeftPosition command
  }
