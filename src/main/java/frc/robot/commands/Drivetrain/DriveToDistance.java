...
public class DriveToDistance extends ParallelRaceGroup {
  ...
  public DriveToDistance(Drivetrain pDrivetrain, double pDistance) {
    ...
    super(new DrivetrainLeftPosition((int) (pDistance * VariableVault.kDrivetrainTicksPerInch)),
    new DrivetrainRightPosition((int)(pDistance * VariableVault.kDrivetrainTicksPerInch)));
  }
}
