...
public class Drivetrain extends SubsystemBase {
  ...
  public final WPI_TalonSRX LeftFront = new WPI_TalonSRX(VariableVault.LeftFrontID);
  public final WPI_TalonSRX LeftRear = new WPI_TalonSRX(VariableVault.LeftRearID);
  public final WPI_TalonSRX RightFront = new WPI_TalonSRX(VariableVault.RightFrontID);
  public final WPI_TalonSRX RightRear = new WPI_TalonSRX(VariableVault.RightRearID);
